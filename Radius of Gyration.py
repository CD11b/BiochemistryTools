...
def atomMVRG(atomID):
    ...
    atomMassVectorRG = [atomMass(atom[0]) * (atom[1] - centerOfMass[0])**2,
                        atomMass(atom[0]) * (atom[2] - centerOfMass[1])**2,
                        atomMass(atom[0]) * (atom[3] - centerOfMass[2])**2]
...
radiusOfGyration = [(summationMVRGX / totalMass)**0.5, (summationMVRGY / totalMass)**0.5, (summationMVRGZ / totalMass)**0.5]
